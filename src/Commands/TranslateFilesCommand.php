...
namespace Javaabu\LaravelDhivehiTranslate\Commands;
...
class TranslateFilesCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'javaabu_translate:files';
     ...
     */
    public function __construct($base_locale = 'en', $locales = 'dv', $target_files = '', $force = false, $json = false, $verbose = true, $excluded_files = 'auth,pagination,validation,passwords')
    {
        parent::__construct();
    ...
    public function handle()
    {
        ...
        $this->locales = array_filter(explode(",", $this->ask('What are the target locales? Comma seperate each lang key', config('javaabu_laravel_translate.default_target_locales','dv'))));
