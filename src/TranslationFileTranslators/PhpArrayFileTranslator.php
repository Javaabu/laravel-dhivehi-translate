...
namespace Javaabu\LaravelDhivehiTranslate\TranslationFileTranslators;
        ...
        foreach ($to_be_translateds as $key => $to_be_translated) {
            if (is_array($to_be_translated)) {
                ...
                if (isset($existing_translations[$key]) && $existing_translations[$key] != '' && !$this->force) {
                    ...
                    $translations[$key] = Str::javaabuTranslate($to_be_translated, $target_locale, $this->base_locale);
